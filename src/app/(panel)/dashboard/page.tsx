    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl xl:text-4xl font-bold text-foreground">Dashboard</h1>
                    <p className="text-muted-foreground text-sm xl:text-base mt-1 flex items-center gap-2">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <a
                        href={`/salao/${userId}`}
                        target="_blank"
                        className="flex items-center gap-2 bg-primary text-primary-foreground px-3 sm:px-5 xl:px-6 py-2.5 xl:py-3 text-xs sm:text-sm xl:text-base font-bold rounded-lg hover:bg-primary/90 transition-all shadow-[0_0_20px_rgba(201,168,76,0.3)] hover:shadow-[0_0_30px_rgba(201,168,76,0.5)] whitespace-nowrap"
                    >
                        + Novo agendamento
                    </a>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="border border-primary/30 bg-primary/10 rounded-lg p-6">
                        <p className="text-primary text-xs xl:text-sm tracking-widest uppercase font-medium mb-3">
                            Produtividade do dia
                        </p>
                        <div className="flex items-end gap-3">
                            <p className="text-4xl xl:text-5xl font-bold text-foreground">
                                R$ {formatBRL(today)}
                            </p>
                            {percentChange !== null && (
                                <span
                                    className={`text-xs xl:text-sm font-medium px-2 py-1 rounded-md mb-1 ${
                                        percentChange >= 0
